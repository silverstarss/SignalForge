...
validation_decoding=do_sample_${VAL_DO_SAMPLE:-False}_temperature_${VAL_TEMPERATURE:-0}_top_p_${VAL_TOP_P:-1.0}_top_k_${VAL_TOP_K:--1}_repetition_penalty_${VAL_REPETITION_PENALTY:-1.0}_n_${VAL_ROLLOUT_N}
validation_do_sample=${VAL_DO_SAMPLE:-False}
validation_temperature=${VAL_TEMPERATURE:-0}
validation_top_p=${VAL_TOP_P:-1.0}
validation_top_k=${VAL_TOP_K:--1}
validation_repetition_penalty=${VAL_REPETITION_PENALTY:-1.0}
validation_n=${VAL_ROLLOUT_N}
