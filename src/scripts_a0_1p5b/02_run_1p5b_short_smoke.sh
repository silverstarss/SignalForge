#!/usr/bin/env bash
# Stage 2: Qwen2.5-1.5B A800 short smoke. Runs training only after preflight passes.
set -euo pipefail
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-A_1p5b_short_smoke}
...
export PREFLIGHT_LAUNCH_SCRIPT=${PREFLIGHT_LAUNCH_SCRIPT:-${SCRIPT_DIR}/02_run_1p5b_short_smoke.sh}
